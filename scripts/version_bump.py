...
""",
    ...
    print(
        f"Please go to https://github.com/sdwilsh/aiobrultech-serial/releases/new to create a new release for v{release_version.major}.{release_version.minor}."
    )
    subprocess.run(
...
v{release_version.major}.{release_version.minor} branch has been cut.""",
    ...
    print(
        f"Please go to https://github.com/sdwilsh/aiobrultech-serial/pull/new/v{next_version}-version-bump to open a pull request."
    )
